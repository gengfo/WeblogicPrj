 ...
 * @author Marcus Hirt
 */
public final class RemoteJRCMD1 {
	...
	public int port = 16203;
	public String cmd = "start_flightrecording duration=30s filename=gengfo.jfr";
	//public String cmd = "help";

	public static void main(String[] args) throws Exception {
		//args[0];
		//HashMap<String, String> commandMap = parseArguments(args);
		RemoteJRCMD1 r = new RemoteJRCMD1();
		
		
		executeCommand("localhost",16203,"", "", r.cmd);
		
		//executeCommand(r.host, r.port, "", "", r.cmd);
		//executeCommand(commandMap.get("-host"),
		//		Integer.parseInt(commandMap.get("-port")),
		//		commandMap.get("-user"), commandMap.get("-password"),
