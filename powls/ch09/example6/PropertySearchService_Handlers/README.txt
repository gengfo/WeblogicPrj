== Example 6 - Using Handlers in a Web Service project ==
...
Note: This test requires the injection of custom SOAP header. Therefore it is
best to test the Web Service by building and deploying the corresponding 
client project in this example 6.
