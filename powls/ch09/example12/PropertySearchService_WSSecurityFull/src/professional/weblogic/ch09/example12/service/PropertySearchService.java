package professional.weblogic.ch09.example12.service;
...
import professional.weblogic.ch09.example12.property.PropertyInfoFault;
import professional.weblogic.ch09.example12.property.PropertyInfoFaultException;
import professional.weblogic.ch09.example12.property.PropertySearchAddress;
import professional.weblogic.ch09.example12.property.PropertySearchId;
...
public class PropertySearchService {
	...
	@Policies({
		...
		@Policy(uri="policy:Wssp1.2-2007-EncryptBody.xml", direction=Policy.Direction.both)
	})
