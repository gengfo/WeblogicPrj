package professional.weblogic.ch09.example2.service;

import javax.jws.WebService;

import professional.weblogic.ch09.example2.property.PropertyInfo;
import professional.weblogic.ch09.example2.property.PropertyInfoFault;
import professional.weblogic.ch09.example2.property.PropertyInfoFault_Exception;
import professional.weblogic.ch09.example2.property.PropertySearchAddress;
import professional.weblogic.ch09.example2.property.PropertySearchId;
import professional.weblogic.ch09.example2.property.PropertySearchService;

@WebService(
		serviceName="PropertySearchService", 
		targetNamespace="http://www.wrox.com/professional-weblogic/PropertySearchService",
		endpointInterface="professional.weblogic.ch09.example2.property.PropertySearchService"
)
public class PropertySearchServiceImpl implements PropertySearchService {
	...
	public PropertyInfo getPropertyDetailsByAddress(PropertySearchAddress searchAddress)
													throws PropertyInfoFault_Exception {
	...
	public PropertyInfo getPropertyDetailsById(PropertySearchId searchId)
									throws PropertyInfoFault_Exception {
