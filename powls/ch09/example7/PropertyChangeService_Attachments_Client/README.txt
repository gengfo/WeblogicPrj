== Example 7 - Using SOAP Attachments in a Web Service Client project ==
...
3. Generate Service Client Stubs
   ...
   from the other project in Example 7 has already been deployed. Run the
   following command to execute the ClientGen Ant task which generates the Web
   Service stub classes using the WSDL from the WebLogic hosted Web Service.
