== Example 3 - Web Service Client project ==
...
3. Generate Service Client Stubs
   ...
   from Example 2 has already been deployed. Run the following command to 
   execute the ClientGen Ant task which generates the Web Service stub classes
   using the WSDL from the WebLogic hosted Web Service.
