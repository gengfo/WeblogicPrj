== Example 4 - Dynamic Web Service Dispatch Client using SOAP Message project ==
...
4. Build and Run Project
   ...
   from the other project in Example 4 has already been deployed. Run the 
   following command which compiles the service class and runs the client 
