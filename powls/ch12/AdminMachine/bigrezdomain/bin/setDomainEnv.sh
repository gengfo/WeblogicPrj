...
BEA_JAVA_HOME="C:/Oracle/Middleware/jrockit_160_05_R27.6.2-20"
export BEA_JAVA_HOME

SUN_JAVA_HOME="C:/Oracle/Middleware/jdk160_11"
...
if [ "${JAVA_VENDOR}" = "Oracle" ] ; then
	...
	if [ "${JAVA_VENDOR}" = "Sun" ] ; then
		...
		JAVA_VENDOR="Oracle"
		export JAVA_VENDOR
		JAVA_HOME="C:/Oracle/Middleware/jrockit_160_05_R27.6.2-20"
		export JAVA_HOME
	fi
fi
...
LONG_DOMAIN_HOME="C:/powls/ch12/AdminMachine/bigrezdomain"
