...
set DOMAIN_NAME=bigrezdomain

set ADMIN_URL=http://diablo:7001
...
if "%1"=="" (
	...
	call "%DOMAIN_HOME%\bin\startWebLogic.cmd" nodebug nopointbase noiterativedev notestconsole noLogErrorsToConsole
) else (
