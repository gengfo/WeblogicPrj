...
usage()
{
	...
	echo "for example:"
	echo "$1 managedserver1 http://everest:7001"
}
...
JAVA_OPTIONS="-Dweblogic.security.SSL.trustedCAKeyStore="/oracle/middleware/wlserver_10.3/server/lib/cacerts" ${JAVA_OPTIONS}"
...
DOMAIN_HOME="/powls/ch12/Machine3/bigrezdomain"
