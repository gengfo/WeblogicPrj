...
SAVE_JAVA_OPTIONS="${JAVA_OPTIONS} -Dweblogic.security.TrustKeyStore=CustomTrust -Dweblogic.security.CustomTrustKeyStoreFileName=/powls/ch12/cacerts -Dweblogic.security.CustomTrustKeyStorePassPhrase=changeit"
