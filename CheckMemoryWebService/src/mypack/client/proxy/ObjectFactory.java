...
public class ObjectFactory {
    ...
    private final static QName _CheckResponse_QNAME = new QName("http://gengfo/ws/CheckMemoryWebService", "checkResponse");
    private final static QName _Check_QNAME = new QName("http://gengfo/ws/CheckMemoryWebService", "check");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gengfo/ws/CheckMemoryWebService", name = "checkResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gengfo/ws/CheckMemoryWebService", name = "check")
